...
with canlib.openChannel(
    ...
    ch.writeWait(wheel.set_report_period_frame(1000), -1)
    ...
    ch.writeWait(wheel.set_report_period_frame(200), -1)

    print(
        "Testing setting incorrect wheel parameters. Data should be abnormally high. Check using logger."
    )
    ch.writeWait(wheel.set_wheel_parameters_frame(5, 1), -1)

    input("Press Enter to continue...")

    # Restore defaults
    ch.writeWait(wheel.set_wheel_parameters_frame(45, 0.16), -1)
