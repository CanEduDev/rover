// NOLINTBEGIN(readability-else-after-return,bugprone-multi-level-implicit-pointer-conversion,readability-inconsistent-declaration-parameter-name)
#include "pwm.h"
...
// NOLINTEND(readability-else-after-return,bugprone-multi-level-implicit-pointer-conversion,readability-inconsistent-declaration-parameter-name)
